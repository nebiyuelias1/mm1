...
float area_num_in_q, area_server_status, mean_interarrival, mean_service,
      ...
      total_of_delays,
      area_num_in_system, total_of_system_delays, *time_arrival_to_system; /* NEW */
FILE  *infile, *outfile;
...
main()  /* Main function. */
{
    ...
    fprintf(outfile, "Number of customers%13d\n\n", num_sample_size_required);
...
void report(void)  /* Report generator function. */
{
    ...
    fprintf(outfile, "\n\nMean system delay %15.3f minutes\n\n",
            total_of_system_delays / num_in_system);
    fprintf(outfile, "Mean system length %14.3f\n\n",
            area_num_in_system / sim_time);
    fprintf(outfile, "Server utilization%15.3f\n\n",
            area_server_status / sim_time);
    fprintf(outfile, "Time simulation ended%15.3f minutes", sim_time);
}
